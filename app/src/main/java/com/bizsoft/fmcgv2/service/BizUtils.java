...
import static com.bizsoft.fmcgv2.service.BlockPage.activity;
        ...
        protected void onPreExecute() {
           ...
           // System.out.println("JSON : " + json);
            ...
            if (url.toLowerCase().contains("order")) {
                ...
                salesOrderx.setLedgerId(Store.getInstance().currentCustomerId.intValue());
                ...
                salesReturnx.setLedgerId(Store.getInstance().currentCustomerId.intValue());
